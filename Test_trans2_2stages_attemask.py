# 修改attention中的信息传递机制，堵塞从video到concept的attention矩阵传递，保留video内部与concept内部的传递，以及concept到video的传递
# 两阶段预测策略
...
import h5py
import pickle
from Test_trans2_2stages_attemask_transformer import transformer
