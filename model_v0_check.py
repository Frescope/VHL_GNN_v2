...
def load_feature_5fold(score_record,video_category,feature_dir):
    ...
    # load data
    subset_indexes = [[],[],[],[],[]]
    subset_indexes[0] = ['kLxoNp-UchI', 'xxdtq8mxegs', '37rzWOQsNIw', '4wU_LUjG5Ic', 'J0nA4VgnoCo', 'VuWGsYPqAX8',
                         'HT5vyqe0Xaw', 'GsAD1KT1xo8', 'Se3oxnaPsz0', 'eQu1rNs0an0']
    subset_indexes[1] = ['E11zDS9XGzg', '0tmA_C6XwfM', 'Yi4Ij2NM7U4', '91IHQYk1IQM', 'AwmHb44_ouw', '_xMr-HKMfVA',
                         'sTEELN-vY30', 'cjibtmSLxQ4', 'WxtbjNsCQ8A', 'qqR6AEXwxoQ']
    subset_indexes[2] = ['jcoYJXDG9sw', 'i3wAGJaaktw', 'Hl-__g2gn_A', 'fWutDQy1nnY', '98MoyGZKHXc', 'xmEERLqJ2kU',
                         'akI8YFjEmUw', 'PJrm840pAUI', 'oDXZc0tZe04', 'JgHubY5Vw3Y']
    subset_indexes[3] = ['-esJrBWj2d8', 'Bhxk-O1Y7Ho', 'LRw_obCPUt0', 'z_6gVvQb2d0', 'XzYM3PfTM4w', 'byxOvuiIJV0',
                         'xwqBXPGE9pQ', 'XkqCExn6_Us', 'EE-bNr36nyA', 'EYqVtI9YWJA']
    subset_indexes[4] = ['NyBmCxDoHJU', '3eYKfiOEJNs', 'WG0MBPpPC6I', 'RBCABdttQmI', 'gzDbaEs1Rlg', 'JKpqYvAdIsw',
                         'vdmoEJ5YbrQ', 'b626MiF1ew4', 'uGu_10sucQo', 'iVt07TCkFM0']
