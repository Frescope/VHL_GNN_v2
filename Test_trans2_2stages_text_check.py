...
import h5py
import pickle
from Test_trans2_2stages_text_transformer import transformer
    ...
    with tf.Graph().as_default():
        ...
        for gpu_index in range(hp.gpu_num):
            with tf.device('/gpu:%d' % gpu_index):
                ...
                concept_logits, summary_logits, reconst_vecs = transformer(features, positions, scores_src, txt_emb, global_embs,
