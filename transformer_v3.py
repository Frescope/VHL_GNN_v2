...
def transformer(global_emb, features, concept_embs, positions, scores_src, drop_out, training, hp, concept_num):
    with tf.variable_scope("transformer", reuse=tf.AUTO_REUSE):
        # encoder & decoder inputs
        concept_nodes = tf.layers.dense(concept_embs, D_MODEL, use_bias=True, activation=None)
        ...
        concept_logits = tf.layers.dense(concept_branch, concept_num, use_bias=True, activation=None)
        ...
        return concept_logits, summary_logits, prediction_logits, reconst_vecs