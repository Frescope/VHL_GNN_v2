...
def transformer(features, positions, scores_src, img_emb, global_emb, drop_out, training, hp):
    with tf.variable_scope("transformer", reuse=tf.AUTO_REUSE):
        ...
        concept_logits = tf.layers.dense(concept_branch, 2, use_bias=True, activation=None)
        ...
        summary_logits = tf.layers.dense(summary_branch, 1, use_bias=True, activation=None)
        summary_logits = tf.squeeze(summary_logits)
