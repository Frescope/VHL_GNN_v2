    ...
    with tf.Graph().as_default():
        ...
        for step in range(hp.maxstep):
            ...
            if step % epoch_step == 0 or (step + 1) == hp.maxstep:
                ...
                p, r, f, t = evaluation_2stages_autothresh(concept_lists, summary_lists, query_summary, Tags, test_vids, concepts, queries)
                logging.info('Precision: %.3f, Recall: %.3f, F1: %.3f, Thresh: %.3f' % (p, r, f, t))
