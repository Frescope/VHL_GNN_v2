...
def transformer(features, positions, scores_src, txt_emb, global_emb, drop_out, training, hp, c_num, s_num):
    with tf.variable_scope("transformer", reuse=tf.AUTO_REUSE):
        ...
        input_nodes = tf.concat([global_nodes, visual_nodes, text_nodes], axis=1)
